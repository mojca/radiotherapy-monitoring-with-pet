...
// ********************************************************************
//
/// \file RTPETStackingAction.cc
/// \brief Implementation of the RTPETStackingAction class
...
RTPETStackingAction::RTPETStackingAction()
{ }
...
RTPETStackingAction::ClassifyNewTrack(const G4Track* track)
{
