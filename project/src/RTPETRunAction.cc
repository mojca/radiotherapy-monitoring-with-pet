...
// ********************************************************************
//
/// \file RTPETRunAction.cc
/// \brief Implementation of the RTPETRunAction class
...
G4Run* RTPETRunAction::GenerateRun()
{ return new RTPETRun; }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void RTPETRunAction::BeginOfRunAction(const G4Run* run)
{
...
void RTPETRunAction::EndOfRunAction(const G4Run* run)
{
  ...
  const RTPETPrimaryGeneratorAction* generatorAction
    = static_cast<const RTPETPrimaryGeneratorAction*>(
  ...
  //results
  //
  const RTPETRun* b3Run = static_cast<const RTPETRun*>(run);
