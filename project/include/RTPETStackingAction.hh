...
// ********************************************************************
//
/// \file RTPETStackingAction.hh
/// \brief Definition of the RTPETStackingAction class

#ifndef RTPETStackingAction_h
#define RTPETStackingAction_h 1
...
class RTPETStackingAction : public G4UserStackingAction
{
  public:
    RTPETStackingAction();
    virtual ~RTPETStackingAction();
